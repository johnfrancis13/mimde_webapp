...
$sql = "UPDATE dbo.final_annotation_table SET live = 1 WHERE id = ? AND qnum = ? AND mcq = ?";
...
$sql = "UPDATE dbo.final_annotation_table SET locktime = GETDATE() WHERE id = ? AND qnum = ? AND mcq = ?";
