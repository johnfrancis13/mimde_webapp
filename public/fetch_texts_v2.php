...
$tsql = "WITH GroupedRandom AS (
    ...
    FROM dbo.final_annotation_table
...
$sqla = "UPDATE dbo.final_annotation_table SET live = 1 WHERE id = ? AND qnum = ?";
$sqlb = "UPDATE dbo.final_annotation_table SET locktime = GETDATE() WHERE id = ? AND qnum = ?";
